...
Различие между конформными и однородными структурами представлено на Рис.11. и Рис.12.
...
- Neovius' Surface (Рис.22.)

![](./media/image26.png)

| <img src="./media/image27.png" width="245" height="228" />                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Рис.22. Neovius' Surface                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
 4.2. Объемная доля                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
 Объемная доля – отношение материала стенок решетки ко всему объему решетки. (В статьях принимается равной 15%). Объемная доля влияет на физические свойства решетки. Например, увеличение объемной доли ведет к увеличению модуля Юнга, но в то же время к уменьшению размеров ячеек и к уменьшению проницаемости структуры. От применения сеточной структуры зависит выбор объемной доли. Для структур, применяемых в медицине, она выбирается таким образом, чтобы свойства структуры совпадали с костью, которую она замещает. В ракето- и аэростроении объемная доля должна обеспечивать минимальный вес конструкции при максимальной жесткости.  |

4.3. Размер элементарной ячейки

Один из важных параметров при проектировании сетчатых структур – размер элементарной ячейки. При неизменной объемной доле количество элементарных ячеек в структуре увеличивается с уменьшением размера элементарной ячейки. (Рис.23.)

| <img src="./media/image28.png" width="205" height="178" />![](./media/image29.png)![](./media/image30.png) |
|------------------------------------------------------------------------------------------------------------|
| Рис.23. Гироид Шоэна с размерами ячейки 2мм, 5мм, 8мм.                                                     |
