...
Значение изоповерхности задается формулой:, где k – значение изоповерхности, f(p) – неявная функция, задающая элементарную ячейку структуры.

Удобнее использовать значение изоповерхности равное 0, в таком случае вышеописанная формула примет вид:
